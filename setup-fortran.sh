...
install_intel_win()
{
  ...
  "$GITHUB_ACTION_PATH/install-intel-base-windows.bat" $WINDOWS_BASEKIT_URL
  "$GITHUB_ACTION_PATH/install-intel-hpc-windows.bat"  $WINDOWS_HPCKIT_URL
